...
const Header = () => {
  ...
  return (
    <>
      <div className={`navbar bg-${darkMode ? "base-900" : "base-100"} max-w-7xl mx-auto`}>
        <div className="flex-1">
          <Link
            to="/"
            className={`btn btn-ghost normal-case text-2xl font-black text-${
              darkMode ? "accent-content" : "accent-content"
            }`}
          >
            <AiFillShopping />
        ...
        <div className="flex-none">
          <Link
            to="/search"
            className={`btn btn-ghost btn-circle text-${darkMode ? "accent-content" : "accent-content"}`}
          >
            <svg
          ...
          <button
            className={`text-${darkMode ? "accent-content" : "accent-content"} btn btn-ghost btn-circle text-xl`}
      ...
      <div className={`navbar-bottom-menu border-y border-gray-800 bg-${darkMode ? "base-900" : "base-100"}`}>
        <div className="drawer">
          ...
          <div className="drawer-side z-10">
            ...
            ></label>
            <ul className={`menu p-4 w-80 min-h-full text-${darkMode ? "base-content" : "base-content"} mt-4`}>
              <label htmlFor="my-drawer" className="btn drawer-button">
        ...
        <div className="container text-2xl navlinks-container">
          <NavLink className={`text-${darkMode ? "base-content" : "base-content"}`} to="/">
            Home
          </NavLink>
          <NavLink className={`text-${darkMode ? "base-content" : "base-content"}`} to="/shop">
            Shop
          </NavLink>
          <NavLink className={`text-${darkMode ? "base-content" : "base-content"}`} to="/about-us">
            About us
          </NavLink>
          <NavLink className={`text-${darkMode ? "base-content" : "base-content"}`} to="/contact">
            Contact
          </NavLink>
          {!isLoggedIn && (
            <>
              <NavLink className={`text-${darkMode ? "base-content" : "base-content"}`} to="/login">
                Login
              </NavLink>
              <NavLink className={`text-${darkMode ? "base-content" : "base-content"}`} to="/register">
                Register
              </NavLink>
            </>
          )}
